...
func capabilityGapCoachingBlock() string {
	return strings.Join([]string{
		...
		"Concrete sequence: create the missing specialist with team_member first; if the work will span more than one turn, create the missing execution channel with team_channel; propose or update the missing skill block in the same turn; and if the blocker is a tool or provider gap, open a tool-discovery/research lane named for the exact tool you need so the team can discover, validate, and enable it.",
