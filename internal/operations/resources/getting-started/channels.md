...
WUPHF puts conversation first on purpose. You do not coordinate your team through a board of cards or a queue of tickets. You coordinate it the way a small, fast company actually coordinates: by talking. The channels and DMs are the surface where you do that, and everything else (issues, tasks, the wiki) hangs off the conversation rather than replacing it.
