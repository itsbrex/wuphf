---
title: Your context graph
created: 2026-06-02
tags: [getting-started, wiki, context]
order: 7
---

# Your context graph

The wiki is not just a pile of pages. It is a context graph, and understanding that is what turns a notes folder into an actual brain for your team.
...
Real context is not frozen. A pricing number that was true last quarter may be wrong this quarter. The context graph treats facts as temporal: a fact can be valid from a point in time and superseded later, so the team can tell the difference between what is true now and what was true then.
