...
// message that teaches ONE AGENT a workflow.
//
...
// does this job") and lands in AppToolsChat. This one addresses an agent in its
...
// honesty gate — the agent's first reply is a capability statement, not a
...
export interface AgentWorkflowSeedInput {
  /** The agent being taught. Used to address the message. */
  agentSlug: string;
...
/**
 * Build the message that hands a captured workflow to an agent.
 *
