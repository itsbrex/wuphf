...
const BLOCK: Silhouette = [
  EMPTY, EMPTY,
  [4, 12], [3, 13], [2, 14], [2, 14], [1, 15], [1, 15],
  [1, 15], [1, 15], [1, 15], [2, 14], [2, 14], [3, 13],
  EMPTY, EMPTY,
];
...
const DOME: Silhouette = [
  EMPTY,
  [6, 10], [4, 12], [3, 13], [2, 14], [2, 14], [1, 15], [1, 15],
...
const DROP: Silhouette = [
  EMPTY,
  [7, 9], [6, 10], [6, 10], [5, 11], [4, 12], [3, 13], [2, 14],
  [2, 14], [1, 15], [1, 15], [1, 15], [2, 14], [3, 13], [5, 11],
  EMPTY,
];
...
const BEAN: Silhouette = [
  EMPTY, EMPTY,
  [3, 6], [2, 7], [2, 14], [1, 15], [1, 15], [1, 15],
  [1, 15], [1, 15], [1, 15], [2, 14], [2, 14], [4, 12],
  EMPTY, EMPTY,
];
...
const LOAF: Silhouette = [
  EMPTY, EMPTY, EMPTY,
  [3, 13], [1, 15], [0, 16], [0, 16], [0, 16],
  [0, 16], [0, 16], [0, 16], [1, 15], [2, 14],
  EMPTY, EMPTY, EMPTY,
];
...
const SHIELD: Silhouette = [
  EMPTY,
  [3, 13], [2, 14], [1, 15], [1, 15], [1, 15], [1, 15], [1, 15],
  [2, 14], [2, 14], [3, 13], [4, 12], [5, 11], [6, 10], [7, 9],
  EMPTY,
];
...
const BLOB: Silhouette = [
  EMPTY,
  [5, 10], [3, 12], [2, 13], [2, 14], [1, 14], [1, 15], [1, 15],
  [1, 15], [1, 15], [2, 15], [2, 14], [3, 14], [4, 12], [6, 10],
  EMPTY,
];

export const SILHOUETTES: readonly Silhouette[] = [
  BLOCK, DOME, DROP, BEAN, PILL, LOAF, SHIELD, BLOB,
];
